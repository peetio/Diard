...
class Document:
    ...
    def __init__(
        ...
        self.ordered = False
        self.images = []
        #   keep original filenames when processing images instead of documents
    ...
    def __set_extracted_data(self, block, img, page, idx):
        ...
        if b_type in ["text", "title", "list"]:
            ...
            if self.image_filenames:
                img_name = self.image_filenames[page] + "-" + str(idx) + "_" + b_type + ".jpg"
            else:
    ...
    def __visualize_predictions(self, predicts, img, index):
        ...
        if self.image_filenames:
            visual_path = visual_dir + self.image_filenames[index] + ".jpg"
        else:
            visual_path = visual_dir + str(index) + ".jpg"
    ...
    def save_layout_as_json(self, page):
        ...
        if self.image_filenames:
            json_path = json_dir + self.image_filenames[page] + ".json"
        else:
    ...
    def save_layout_as_html(self, page):
        ...
        if self.image_filenames:
            html_path = html_dir + self.image_filenames[page] + ".html"
        else:
            html_path = html_dir + str(page) + ".html"
    ...
    def set_images(self):
        ...
        if numbered:
            ...
            self.image_filenames = ['.'.join(fn.split('.')[:-1]) for fn in img_filenames]
